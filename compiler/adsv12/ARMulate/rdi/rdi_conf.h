 ...
 * Copyright (C) 1998-2001 Advanced Risc Machines Ltd. All rights reserved.
 */

/*
 * RCS $Revision: 1.22.4.3 $
 * Checkin $Date: 2001/06/15 12:13:43 $
...
#define Dbg_Cnf_Target_Board (tag_t)"TARGET_BOARD"
#define Dbg_Cnf_Target_ControllerIsAnAgent (tag_t)"TARGET_CONTROLLERISANAGENT"
#define Dbg_Cnf_Target_Processor (tag_t)"TARGET_PROCESSOR"
#define Dbg_Cnf_Target_ProcessorRevision (tag_t)"TARGET_PROCESSOR_REVISION"
