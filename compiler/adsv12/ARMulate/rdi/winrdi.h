 ...
 * Copyright (C) 1996-2001, Advanced RISC Machines Limited. All Rights Reserved
 */

/*
 * RCS $Revision: 1.28.2.8 $
 * Checkin $Date: 2001/07/27 09:34:03 $
...
#define WinRDIInfo_Reserved_0x1003 0x1003 /* This number is reserved */

/*
 *        Function: WinRDIInfo_ModuleServerCapabilities
...
#define WinRDIInfo_ModuleServerCapabilities 0x1004
