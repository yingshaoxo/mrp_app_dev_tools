/*
 * ARM RDI : rdi.h
 * Copyright (C) 1994-2001 ARM Limited. All rights reserved.
 */

/*
 * RCS $Revision: 1.20.4.4 $
...
#define RDIPoint_8Bit           256  /* 8-bit breakpoint (Java)         */
#define RDIPoint_Java           RDIPoint_8Bit /* Historical synonym     */
