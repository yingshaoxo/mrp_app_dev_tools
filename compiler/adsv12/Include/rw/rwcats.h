...
#define __ARM_RWSTD_NO_CATS_AT_ALL 1 /* ARM added */
  ...
  class __rwcat
  {
    public:
      ...
      ~__rwcat() { ; }
      __rwcat* id() { _RWSTD_UNUSED(this); return this; }
      bool good() { _RWSTD_UNUSED(this); return false; }
#ifdef ORIG
      char * catgets(int set_num, int msg_num, const char* s) { return s; }
#else
      char * catgets(int /*set_num*/, int /*msg_num*/, const char* s) { _RWSTD_UNUSED(this); return _RWSTD_CONST_CAST(char*,s); }
#endif
  };
