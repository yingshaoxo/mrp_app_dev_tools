#ifndef __STD_RW_RW_NUMERAL_CC__
#define __STD_RW_RW_NUMERAL_CC__
     ...
     ios_base::iostate& err, unsigned short& value) const
{
  ...
  if (reader.error
    ...
    value=_RWSTD_STATIC_CAST(unsigned short,v);
     ...
     ios_base::iostate& err, unsigned int& value) const
{
  ...
  if (reader.error
    ...
    value=_RWSTD_STATIC_CAST(unsigned int, v);
...
#endif // __STD_RW_RW_NUMERAL_CC__
