...
#else // ! def _RWSTD_LOCALIZED_ERRORS

// This could be extended to the _RWSTD_LOCALIZED_ERRORS case, too
#ifdef _RWSTD_RWSE_ARE_POINTERS
#define _RWSTD_EX_MSG(x) const char _RWSTDExportFunc(*) x
#else
// ARM case
#define _RWSTD_EX_MSG(x) const char _RWSTDExport x[]
#endif

#endif // ! def _RWSTD_LOCALIZED_ERRORS
