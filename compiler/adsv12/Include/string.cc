#ifndef __STD_RW_STRING_CC__
#define __STD_RW_STRING_CC__
...
#ifdef NO_ARM_CHEAP_NULL_STRING_REF_REP
  const /* not const because we can't handle '= { { 0 } }' initializer */
#endif
        _TYPENAME basic_string<charT, traits, Allocator>::__null_ref_type
...
#define npos (size_type)-1
  ...
  {
    size_type len2 = str.length();
    _RWSTD_THROW(pos2 > len2,out_of_range,
     __RWSTD::except_msg_string(__RWSTD::__rwse_PosBeyondEndOfString,
